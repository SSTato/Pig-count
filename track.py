...
def parse_opt():
    ...
    parser.add_argument('--yolo-weights', nargs='+', type=str, default='best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--source', type=str, default='pig1.mp4', help='file/dir/URL/glob, 0 for webcam')
